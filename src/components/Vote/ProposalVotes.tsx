...
export const ProposalVotes = ({ votes, result, proposal, space }: ProposalVotesProps) => {
			...
			header={
				<div className="d-flex flex-column justify-content-around">
					<Styled.BoxHeader>
						...
						{votes && (
							<span
								className={`label label-light-primary label-lg fw-bolder d-flex label-inline py-3 ms-3`}
							>
