	...
	return (
		<Column style={{ width: "100%", flex: "1 1" }}>
			...
			<PaddedColumn gap="14px">
				<Text fontWeight={600}>
					Add a list{" "}
					<QuestionTooltip text="Token lists are an open specification for lists of ERC20 tokens. You can use any token list by entering its URL below. Beware that third party token lists can contain fake or malicious ERC20 tokens." />
				</Text>
				<CustomRow>
					<FormControl
						type="text"
